$(function () {
    ...
    $(".fa-sun").on("click", function () {
        localStorage.setItem("sun", "light-theme");
        $("html").attr("class", "light-theme");
    });

    $(".fa-moon").on("click", function () {
        localStorage.setItem("moon", "dark-theme");
        $("html").attr("class", "dark-theme");
    });
    ...
    $(".fa-sun").on("click", function () {
        ...
        $("html").attr("class", localStorage.getItem("sun"));
    });
    ...
    $(".fa-moon").on("click", function () {
        ...
        $("html").attr("class", localStorage.getItem("moon"));
    });

    if (localStorage.getItem("sun") == "light-theme") {
        $("html").attr("class", "light-theme");
        $(".fa-moon").show();
        $(".fa-sun").hide();
    } else if (localStorage.getItem("moon") == "dark-theme") {
        $("html").attr("class", "dark-theme");
        $(".fa-sun").show();
        $(".fa-moon").hide();
    }
