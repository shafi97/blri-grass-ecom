...
class DBTool
{
     ...
     * @return bool
     */
    public static function backupDatabaseTables(\PDO $pdo, $tables = '*', string $filePath = '/'): bool
    {
        try {
     ...
     * @param string $locale
     */
    public static function convertTranslatableDataToJson(string $tableName, array $columns, string $locale = 'en')
    {
        if (count($columns) > 0) {
